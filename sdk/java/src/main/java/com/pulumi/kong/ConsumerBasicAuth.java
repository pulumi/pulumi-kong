...
public class ConsumerBasicAuth extends com.pulumi.resources.CustomResource {
     ...
     */
    public ConsumerBasicAuth(java.lang.String name) {
     ...
     */
    public ConsumerBasicAuth(java.lang.String name, ConsumerBasicAuthArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public ConsumerBasicAuth(java.lang.String name, ConsumerBasicAuthArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kong:index/consumerBasicAuth:ConsumerBasicAuth", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private ConsumerBasicAuth(java.lang.String name, Output<java.lang.String> id, @Nullable ConsumerBasicAuthState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kong:index/consumerBasicAuth:ConsumerBasicAuth", name, state, makeResourceOptions(options, id), false);
    }

    private static ConsumerBasicAuthArgs makeArgs(ConsumerBasicAuthArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? ConsumerBasicAuthArgs.Empty : args;
    }
     ...
     */
    public static ConsumerBasicAuth get(java.lang.String name, Output<java.lang.String> id, @Nullable ConsumerBasicAuthState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
