...
public final class PluginState extends com.pulumi.resources.ResourceArgs {
    ...
    @Import(name="computedConfig")
    private @Nullable Output<String> computedConfig;

    public Optional<Output<String>> computedConfig() {
        return Optional.ofNullable(this.computedConfig);
    }
    ...
    public static final class Builder {
        ...
        public Builder computedConfig(@Nullable Output<String> computedConfig) {
            $.computedConfig = computedConfig;
            return this;
        }

        public Builder computedConfig(String computedConfig) {
            return computedConfig(Output.of(computedConfig));
        }
