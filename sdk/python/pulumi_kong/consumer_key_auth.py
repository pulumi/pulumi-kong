...
class ConsumerKeyAuthArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] consumer_id: the id of the consumer to associate the credentials to
        :param pulumi.Input[builtins.str] key: Unique key to authenticate the client; if omitted the plugin will generate one
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] tags: A list of strings associated with the consumer key auth for grouping and filtering
        """
...
class ConsumerKeyAuth(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            consumer_id: Optional[pulumi.Input[builtins.str]] = None,
            key: Optional[pulumi.Input[builtins.str]] = None,
            tags: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None) -> 'ConsumerKeyAuth':
        """
