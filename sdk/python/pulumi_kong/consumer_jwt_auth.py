...
class ConsumerJwtAuthArgs:
    def __init__(__self__, *,
                 ...
                 rsa_public_key: pulumi.Input[_builtins.str],
        ...
        :param pulumi.Input[_builtins.str] secret: If algorithm is `HS256` or `ES256`, the secret used to sign JWTs for this credential. If left out, will be auto-generated
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] tags: A list of strings associated with the consumer JWT auth for grouping and filtering
        """
    ...
    def rsa_public_key(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    def rsa_public_key(self, value: pulumi.Input[_builtins.str]):
...
class ConsumerJwtAuth(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            rsa_public_key: Optional[pulumi.Input[_builtins.str]] = None,
            secret: Optional[pulumi.Input[_builtins.str]] = None,
            tags: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = None) -> 'ConsumerJwtAuth':
        """
    ...
    @_builtins.property
    @pulumi.getter(name="rsaPublicKey")
    def rsa_public_key(self) -> pulumi.Output[_builtins.str]:
        """
        If algorithm is `RS256` or `ES256`, the public key (in PEM format) to use to verify the token’s signature
        """
        return pulumi.get(self, "rsa_public_key")
