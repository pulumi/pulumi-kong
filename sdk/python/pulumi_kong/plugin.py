...
class PluginArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] enabled: whether the plugin is enabled or not, use if you want to keep the plugin installed but disable it
        :param pulumi.Input[_builtins.str] route_id: the route id that you want to configure the plugin for
        :param pulumi.Input[_builtins.str] service_id: the service id that you want to configure the plugin for
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] tags: A list of strings associated with the Plugin for grouping and filtering
        """
...
class Plugin(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="computedConfig")
    def computed_config(self) -> pulumi.Output[_builtins.str]:
        return pulumi.get(self, "computed_config")
    ...
    @_builtins.property
    @pulumi.getter(name="routeId")
    def route_id(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        the route id that you want to configure the plugin for
        """
        return pulumi.get(self, "route_id")
    ...
    @_builtins.property
    @pulumi.getter(name="strictMatch")
    def strict_match(self) -> pulumi.Output[Optional[_builtins.bool]]:
        return pulumi.get(self, "strict_match")
