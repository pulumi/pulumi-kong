...
class PluginArgs:
    def __init__(__self__, *,
                 ...
                 strict_match: Optional[pulumi.Input[builtins.bool]] = None,
                 tags: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        The set of arguments for constructing a Plugin resource.
        :param pulumi.Input[builtins.str] config_json: this is the configuration json for how you want to configure the plugin.  The json is passed straight through to kong as is.  You can get the json config from the Kong documentation
               page of the plugin you are configuring
        :param pulumi.Input[builtins.str] consumer_id: the consumer id you want to configure the plugin for
        :param pulumi.Input[builtins.bool] enabled: whether the plugin is enabled or not, use if you want to keep the plugin installed but disable it
        :param pulumi.Input[builtins.str] route_id: the route id that you want to configure the plugin for
        :param pulumi.Input[builtins.str] service_id: the service id that you want to configure the plugin for
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] tags: A list of strings associated with the Plugin for grouping and filtering
        """
    ...
    def strict_match(self) -> Optional[pulumi.Input[builtins.bool]]:
        return pulumi.get(self, "strict_match")

    @strict_match.setter
    def strict_match(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _PluginState:
    def __init__(__self__, *,
                 computed_config: Optional[pulumi.Input[builtins.str]] = None,
                 config_json: Optional[pulumi.Input[builtins.str]] = None,
                 consumer_id: Optional[pulumi.Input[builtins.str]] = None,
                 enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    def computed_config(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "computed_config")

    @computed_config.setter
    def computed_config(self, value: Optional[pulumi.Input[builtins.str]]):
...
class Plugin(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            service_id: Optional[pulumi.Input[builtins.str]] = None,
            strict_match: Optional[pulumi.Input[builtins.bool]] = None,
            tags: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None) -> 'Plugin':
        """
    ...
    @property
    @pulumi.getter(name="computedConfig")
    def computed_config(self) -> pulumi.Output[builtins.str]:
        return pulumi.get(self, "computed_config")
    ...
    @property
    @pulumi.getter(name="strictMatch")
    def strict_match(self) -> pulumi.Output[Optional[builtins.bool]]:
        return pulumi.get(self, "strict_match")
