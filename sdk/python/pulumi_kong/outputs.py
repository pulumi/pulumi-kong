...
class UpstreamHealthchecksActive(dict):
    ...
    def __init__(__self__, *,
                 ...
                 https_sni: Optional[builtins.str] = None,
                 https_verify_certificate: Optional[builtins.bool] = None,
    ...
    def https_sni(self) -> Optional[builtins.str]:
        return pulumi.get(self, "https_sni")

    @property
    @pulumi.getter(name="httpsVerifyCertificate")
    def https_verify_certificate(self) -> Optional[builtins.bool]:
...
class UpstreamHealthchecksActiveHealthy(dict):
    ...
    def __init__(__self__, *,
                 http_statuses: Optional[Sequence[builtins.int]] = None,
    ...
    def http_statuses(self) -> Optional[Sequence[builtins.int]]:
...
class UpstreamHealthchecksActiveUnhealthy(dict):
    ...
    def __init__(__self__, *,
                 http_failures: Optional[builtins.int] = None,
                 http_statuses: Optional[Sequence[builtins.int]] = None,
                 interval: Optional[builtins.int] = None,
                 tcp_failures: Optional[builtins.int] = None,
                 timeouts: Optional[builtins.int] = None):
    ...
    def http_failures(self) -> Optional[builtins.int]:
    ...
    def tcp_failures(self) -> Optional[builtins.int]:
        return pulumi.get(self, "tcp_failures")

    @property
    @pulumi.getter
    def timeouts(self) -> Optional[builtins.int]:
